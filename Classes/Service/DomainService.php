...
class Tx_Tool_Service_DomainService implements t3lib_Singleton {
	 ...
	 * @param boolean|string $value The value to search for among annotation values. Defaults to TRUE which means the annotation must simply be present
	 ...
	 * @param boolean|string $value The value which annotation must contain - default is TRUE meaning annotation must simply be present
	 * @return boolean
	 * @api
	 */
	 ...
	 * @param boolean|string $value The value to search for; multiple values may be used in the annotation; $value must be present among them. If TRUE, all properties which have the annotation are returned
